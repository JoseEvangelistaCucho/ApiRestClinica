package com.proyecto.rest.configurationSwagger;
...
@Configuration
public class configurationSwagger  extends WebMvcConfigurerAdapter{
    
	@Bean
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.proyecto.rest"))
